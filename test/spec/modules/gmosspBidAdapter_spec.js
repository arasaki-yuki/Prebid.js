...
describe('GmosspAdapter', function () {
  ...
  describe('buildRequests', function () {
    ...
    it('sends bid request to ENDPOINT via GET', function () {
      ...
      expect(requests[0].data).to.equal('tid=791e9d84-af92-4903-94da-24c7426d9d0c&bid=2b84475b5b636e&ver=3.20.0-pre&sid=123456&url=https%3A%2F%2Fhoge.com&cur=JPY&dnt=0&');
    });
  });
